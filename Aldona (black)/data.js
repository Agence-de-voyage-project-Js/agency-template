...
const volSelection = JSON.parse(localStorage.getItem("volsSeletion"));
var description = document.getElementById("description").value;
description = volSelection[0].numVol;
